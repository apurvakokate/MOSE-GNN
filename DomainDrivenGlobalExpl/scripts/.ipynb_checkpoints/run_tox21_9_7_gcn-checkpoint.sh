            ...
            do
                ...
                do 
                    ...
                    do
                        ...
                        mkdir $FOLDER
                        python 1_run_EXPT_MultiChannel.py --dataset_name $DATASETNAME --seed $SEED --fold $FOLD --algorithm $ALGORITHM --layer_type $LAYERTYPE --task_type MultiTask --model_type $MODELTYPE --size_reg 0.0 --date_tag 0127 --epochs 500 --output_dir $FOLDER > $FOLDER/EXPT-out.out 2>&1
