            ...
            do
                ...
                do 
                    ...
                    do
                        ...
                        mkdir $FOLDER
                        python 4_run_vanilla_compare.py --dataset_name $DATASETNAME --seed $SEED --fold $FOLD --algorithm $ALGORITHM --layer_type $LAYERTYPE --task_type Regression --model_type $MODELTYPE --size_reg 0.0 --date_tag 0205 --epochs 500 --output_dir $FOLDER --vanilla_dir $VanillaFOLDER
